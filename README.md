...
This is a fork of [lit-gpt](https://github.com/Lightning-AI/litgpt), customized to support RoBERTa-base architecture for masked language modeling (MLM) pretraining. The implementation follows HuggingFace-style conventions while integrating seamlessly with the existing Lit-GPT codebase.
...
| Roberta-base | 125M | Facebook AI | [Liu et al. 2019](https://arxiv.org/abs/1907.11692)                                                                         |
| R1 Distill Llama | 8B, 70B | DeepSeek AI | [DeepSeek AI 2025](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf)                                                                                 |
